...
use_WB = 0 # if 1 use Weights&Biases, if 0 not use
...
def train(config_path):
    ...
    valid_no = np.array(range(199, 200))
    ...
    if use_WB == 1:
        wandb.init(
            ...
            project="ModalGNN_TimeDomain_paper",
    ...
    for epoch in range(config['train']['epochs']):
        ...
        # if use_WB == 1:
        #     wandb.log({"loss_valid": loss1_valid + loss2_valid + loss3_valid,
